---
id: mdl-05
title: New-SlashOpsCommandPlan orchestration
version: v0.1
group: model
subgroup: plan
sequence: 5
depends_on: [mdl-03, mdl-04]
status: todo
tdd_first: true
prd_refs:
  - "PRD §6.5 Model request contract (lines 550-583)"
  - "PRD §6.1 Module commands — Safety functions (lines 430-441)"
deliverables:
  - src/SlashOps/Public/New-SlashOpsCommandPlan.ps1
  - tests/Unit/Model.CommandPlan.Tests.ps1
tags: [model, plan, generation, orchestration]
---
